...
class RoadObject:
    def __init__(self, x, y, size, color, object_type=0, speed_multiplier=1.0):
        self.x = x
        self.y = y
        self.size = size
        self.color = color
...
class PowerUp(RoadObject):
    def __init__(self, x, y, power_type):
        ...
        super().__init__(x, y, 15, self.get_color_for_type(power_type), 0, 1.0)
...
class RoadObjectManager:
    def __init__(self, obstacle_frequency=0.02, speed_multiplier=1.0):
        self.objects = []
    ...
    def update(self, car):
        ...
        if (len(self.objects) < 10 and 
            ...
            if is_power_up:
                ...
                self.objects.append(PowerUp(x_pos, -20, power_type))
            else:
                ...
                self.objects.append(RoadObject(
                    x_pos, y_pos, size, color, object_type, self.speed_multiplier
                ))
