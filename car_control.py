...
class ImprovedCarController:
    ...
    def _command_worker(self):
        ...
        while self.running:
            try:
                ...
                # Send the command
                success = self._send_command_direct(command)
    ...
    def translate_gesture(self, gesture_data):
        ...
        if braking:
            ...
            return "FORWARD"  # Could be a special "BOOST" command if car supports it
    ...
    def close(self):
        ...
        self.running = False
        if self.worker_thread and not self.simulation_mode:
